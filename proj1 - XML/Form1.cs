...
namespace proj1___XML
{
    public partial class Form1 : Form
    {
        ...
        private Boolean firstTime = true; //boolean chỉ hiển thị thông báo xml một lần
        ...
        private void WriteXmlFile()
        {
            ...
            XElement inputEmployee = GenerateXElement(); // Tạo XElement từ các điều khiển đầu vào đã nhập

            if (File.Exists(xmlFilePath)) //nếu có file xml thì thêm vào
                AddElement(inputEmployee);
            else                          // else thì tạo tệp và lưu phần tử đầu tiên
        ...
        private XElement GenerateXElement()  // tạo XElement từ đầu vào đã nhập
        {
        ...
        private void LoadText()
        {
            ...
            sr.Close();
            if (firstTime)
            {  // chỉ hiển thị thông báo một lần để giữ cho người dùng khỏi đầu vào đã nhập
